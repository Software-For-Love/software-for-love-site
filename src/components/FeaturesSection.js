            ...
            >
              ...
              {_.get(feature, "carousels", null) && (
                ...
                >
                  ...
                  <Carousel flickityOptions={{wrapAround:true,draggable:false,pageDots=false}}>
                    {feature["carousels"]["items"].map((item) => {
                      return (
                        <div class="carousel-cell carousel-content">
                          {_.get(section, "image", null) && (
                            <div
                              className={classNames("cell", "section__media", {
                                "section__media--right":
                                  _.get(section, "image_position", null) ===
                                  "right",
                              })}
                            >
                              <img
