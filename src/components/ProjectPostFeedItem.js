...
export default class ProjectPostFeedItem extends React.Component {
    render() {
        let project_feed_section = _.get(this.props, 'project_feed_section', null);
                ...
                <div className="card__body">
                  <header className="card__header">
                    {_.get(post, 'frontmatter.categories', null) && (
                      <ProjectPostCategories {...this.props} categories={_.get(post, 'frontmatter.categories', null)} container_class={'card__meta'} />
                    )}
                    {_.get(project_feed_section, 'title', null) ? (
