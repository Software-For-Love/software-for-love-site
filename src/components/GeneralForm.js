                ...
                <div className="section__actions btn-group">
                  <SectionActions {...this.props} actions={_.get(section, 'actions', null)} />
                    ...
                    {/* {_.get(section, 'has_form', null) && ( */}
                      <form name="general-form" id="general-form" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" action="/thankyou" onSubmit={() => handleSubmit} >
                        
                        <input aria-labelledby="honeypot-label" type="hidden" name="form-name" value="general-form" />
                        ...
                        {/* {_.get(section, 'subject', null) && ( */}
                          <input aria-labelledby="honeypot-label" type="hidden" id="subject" name="subject" value="General Inquiry" />
                        {/* )} */}
