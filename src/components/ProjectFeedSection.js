                  ...
                  {_.map(posts_sorted, (post, post_idx) => {
                      ...
                      return (<React.Fragment key={post_idx + '.1'}>
                        {(is_post && ((show_recent === false) || (post_count < recent_count))) && ((() => {
                            ...
                            return (
                              <ProjectFeedItemFilter ProjectPostFeedItem key={post_idx} {...this.props} project_feed_section={section} post_page={post} section_author={section_author} section_category={section_category} />
                            );
                        })())}
                      </React.Fragment>)
                  })}
