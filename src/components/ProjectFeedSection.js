...
export default class ProjectFeedSection extends React.Component {
    render() {
        ...
        let post_count = 0;
        if (_.get(section1, 'author', null)) {
             section_author = getData(this.props.pageContext.site.data, _.get(section1, 'author', null));}
        if (_.get(section1, 'category', null)) {
             section_category = getData(this.props.pageContext.site.data, _.get(section1, 'category', null));}
        return (
