...
export default class Carousel extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <section class="container js-flickity"
        ...
        <div class="carousel-cell carousel-content">
          <div class="content-wrapper">
              ...
              <div class="overflow-container">
                <p class="testimonial"> Do not let arrogance go to your head and despair to your heart; do 
                ...
                <p class="author">Joe M.,<span> CEO of </span> Company</p>
              </div>
          </div>
        </div>
        <div class="carousel-cell carousel-content">
          <div class="content-wrapper">
              ...
              <div class="overflow-container">
                <p class="testimonial">  This is an example of a testimonial from a client... it’s still going... 
                </p>
                <div class="seperator"></div>
                <p class="author">Joe M.,<span> CEO of </span> Company</p>
              </div>
