                        ...
                        <div className="cell section__body">
                            ...
                            >
                                ...
                                <input
                                    ...
                                    id="subject"
                                    name="subject"
                                    value="A potential client wants to work with SFL"
                                />
                                ...
                                <div className="form-group">
                                    <label id="phone-label" htmlFor="tel">
                                        Phone Number {required_star}{" "}
                                    </label>
                                    <PhoneInput
                                ...
                                <div className="form-group form-checkbox">
                                    ...
                                    <label id="consent-label" htmlFor="consent">
                                        ...
                                        my submitted information so I can be
                                        contacted. {required_star}
                                    </label>
                                </div>
